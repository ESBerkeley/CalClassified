...
from cc.django_facebook.connect import CONNECT_ACTIONS, connect_user
from cc.django_facebook.decorators import facebook_required_lazy
from cc.django_facebook.utils import next_redirect, get_registration_backend, \
    to_bool, error_next_redirect, get_instance_for
from cc.open_facebook import exceptions as open_facebook_exceptions
from cc.open_facebook.utils import send_warning
import logging
...
def profile_status(request):
    ...
    return render_to_response('profile.html', 
                            {'my_circles':my_circles, 'bookmarks':bookmarks},
