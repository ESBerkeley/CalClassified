...
def connect(request):
    ...
    if facebook_login:
        ...
        if 'next' in request.GET:
            return next_redirect(request, redirect_url=request.GET['next'], default=facebook_settings.FACEBOOK_LOGIN_DEFAULT_REDIRECT)
    ...
    return next_redirect(request, redirect_url='/accounts/profile/', default=facebook_settings.FACEBOOK_LOGIN_DEFAULT_REDIRECT)
